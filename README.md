...
A comprehensive collection of [agent skills](https://agentskills.io/) for the Meson build system.
...
The repository contains the following agent skills, organized by topic:

### Core Skills

- **[meson-build-system](skills/meson-build-system/)** — Entry point for Meson fundamentals.
